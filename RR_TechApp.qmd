...
Code and data are available on GitHub for the [dashboard](https://github.com/TARTARE-Ethiopia/ETH_Dashboard) and [technical appendix](https://github.com/TARTARE-Ethiopia/ETH-TechApp).
